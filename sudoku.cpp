// sudoku.cpp : Este archivo contiene la función "main". La ejecución del programa comienza y termina ahí.
//Abraham torres
...
void input() {
	char t;
	cout << "Introduzca datos para formar el tablero, vacío con 0 para \ n";
	for (int i = 0; i < 9; i++) {
		for (int j = 0; j < 9; j++) {
			cin >> t;
			P[i][j] = t - '0';
